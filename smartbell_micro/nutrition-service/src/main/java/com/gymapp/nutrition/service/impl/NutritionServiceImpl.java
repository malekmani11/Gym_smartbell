package com.gymapp.nutrition.service.impl;
...
import com.gymapp.nutrition.entity.User;
import com.gymapp.nutrition.mapper.EntityMapper;
import com.gymapp.nutrition.repository.MealRepository;
import com.gymapp.nutrition.repository.NutritionPlanRepository;
import com.gymapp.nutrition.repository.UserRepository;
import com.gymapp.nutrition.service.NutritionService;
...
public class NutritionServiceImpl implements NutritionService {
    ...
    public MealDTO updateMeal(Long mealId, MealDTO dto) {
        ...
        if (dto.getMealType() != null)     meal.setMealType(dto.getMealType());
        if (dto.getDayNumber() != null)    meal.setDayNumber(dto.getDayNumber());
        if (dto.getCalories() != null)     meal.setCalories(dto.getCalories());
        if (dto.getProteinGrams() != null) meal.setProteinGrams(dto.getProteinGrams());
        if (dto.getCarbsGrams() != null)   meal.setCarbsGrams(dto.getCarbsGrams());
        if (dto.getFatGrams() != null)     meal.setFatGrams(dto.getFatGrams());
        if (dto.getDescription() != null)  meal.setDescription(dto.getDescription());
