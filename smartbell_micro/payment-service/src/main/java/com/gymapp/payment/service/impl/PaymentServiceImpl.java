package com.gymapp.payment.service.impl;
...
import com.gymapp.payment.exception.BadRequestException;
import com.gymapp.payment.mapper.EntityMapper;
import com.gymapp.payment.repository.PaymentRepository;
import com.gymapp.payment.repository.SubscriptionRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentStatsDTO getStats() {
        ...
        return PaymentStatsDTO.builder()
                ...
                .completedCount(paymentRepository.countByStatus(PaymentStatus.COMPLETED))
